    ...
    def create_interactive_comparison(
        ...
        if include_animation and animation_data:
            ...
            if method_paths:
                ...
                # Create animation using the MethodAnimation component
                ...
                fig = animation.add_animation_to_plotly_figure(
                    fig=fig,
        ...
        fig.update_layout(
            margin=dict(t=120, **{k: v for k, v in margin_settings.items() if k != "t"})
        )
